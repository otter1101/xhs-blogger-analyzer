...
| **v2.0** | **API + 合规改造发版**<br>🔹 **API 基建**：TikHub 公开数据 API 接入、多端点 Fallback 架构（4 组×7 类端点池）、启动时端点自动探测、评论独立探测、数据质量自愈<br>🔹 **合规改造**：评论者身份脱敏（读者1 / 读者2 / 作者）、首次运行免责横幅、`DISCLAIMER.md` / `SECURITY.md` 文档体系上线、零模拟登录 / 零 Cookie 注入 |
